...
joblib.dump(main_clf, 'ata_classif_linearsvc_2022_10_11.pkl')
joblib.dump(main_clf_1, 'subata_classif_linearsvc_2022_10_11.pkl')
joblib.dump(vectorizer, 'vectorizer_2022_10_11.pkl')

discs_more_50['PREDICTED_ATA'] = main_clf.predict(x_train)
discs_more_50.to_excel('ata_pred_discs_more_than_50.xlsx')

subata_discs['PREDICTED_SUBATA'] = main_clf_1.predict(subata_x_train)
subata_discs.to_excel('subata_pred_discs_more_than_10.xlsx')