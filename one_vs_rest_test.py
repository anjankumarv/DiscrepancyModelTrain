...
loaded_model = joblib.load('subata_classif_logis_withzerosubata.pkl')
...
vectorizer = joblib.load('subata_vectorizer_withzerosubata.pkl')
...
for i, val in enumerate(test_discs.SUBATA.values):
        #check top 5
