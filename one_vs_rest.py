...
clf = LogisticRegression(random_state=0,  multi_class='ovr', n_jobs = -1).fit(x_train, train_discs.SUBATA_PRED.values)
...
joblib.dump(clf, 'subata_classif_logis_withzerosubata.pkl')
joblib.dump(vectorizer, 'subata_vectorizer_withzerosubata.pkl')
