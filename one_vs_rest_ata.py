...
clf = LogisticRegression(random_state=0,  multi_class='ovr', n_jobs = -1).fit(x_train, train_discs.ATA_LOOKUP.values)
...
joblib.dump(clf, 'ata_classif_logis.pkl')
joblib.dump(vectorizer, 'ata_vectorizer.pkl')
